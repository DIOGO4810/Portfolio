...
function Competencias() {
  return (
    <div>
      <h1 className="title" style={{ marginBottom: "20px" }}>Competências Técnicas</h1>
      <div className="grid-parents ">
        <div className="containerGrid size-max">
          ...
          <a href="https://tailwindcss.com/" target="_blank" rel="noopener noreferrer">
            <Icon icon="skill-icons:tailwindcss-dark" width="100" height="100" />
          </a>
          ...
          <a href="https://reactnative.dev/" target="_blank" rel="noopener noreferrer">
            <Icon icon="devicon:reactnative-wordmark" width="100" height="100" />
          </a>
